...
public class Game extends Canvas {
        ...
        private boolean fillPressed = false; // true if firing
        ...
        private long fillingTime = 500; // time it takes to fill a mug (ms)
        private int customerCount; // # of customers left on screen
    	...
    	public Game() {
    		...
    		JFrame container = new JFrame("Lemonade Tapper");
        ...
        public void tryToFill() {
          ...
          if ((System.currentTimeMillis() - lastFire) < fillingTime){
            return;
          } // if
	...
	private class KeyInputHandler extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
                  ...
                  // respond to move left, right or fill
	...
	Rectangle [][] tileMap = new Rectangle[20][16];
	...
	int y = 0;
		...
		//initializing each rectangle object
		for(int i = 0; i < screenWidth / dimension.getWidth(); i++) {
			for(int j = 0; j < screenHeight / dimension.getHeight(); j++) {
				Point point = new Point(x, y);
				tileMap[i][j] = new Rectangle(point, dimension);
				x += 64;				
			}
			x = 0;
			y += 64;
	...
	public static void print2DArray(Rectangle[][] tileMap) {
		for(int i = 0; i < tileMap.length; i++) {
			for(int j = 0; j < tileMap[i].length; j++) {
				System.out.println(tileMap[i][j].toString());
			}
		}	
	}//print2DArray
